...
use App\Http\Controllers\ImageContrller;
...
Route::post('/products/{id}/status',[ProductController::class,'status'])->name('product.status');
//for Images

Route::resource('/images',ImageContrller::class);
